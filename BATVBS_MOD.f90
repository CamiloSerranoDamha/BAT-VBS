...
CONTAINS
    ...
    SUBROUTINE BAT_INVERSION_SIMULATION(n_species, M_j, O2C_j, H2C_j, N2C_j, Group_j, C_PM_j, a_water, &
        ...
        ! Mass fractions
        w_j_alpha = w_water_alpha! Coa_j_onlyalpha/C_PM_alpha          ! Mass fraction of organic species j that is in phase alpha
        w_j_beta = w_water_beta ! Coa_j_onlybeta/C_PM_beta             ! Mass fraction of organic species j that is in phase beta
