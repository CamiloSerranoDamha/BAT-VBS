...
SUBROUTINE BAT_INVERSION_VBS(N_a_water, N_org, M_org_j, O2C_org_j, H2C_org_j, N2C_org_j, C_sat_org_j, C_gas_particle_org_j, &
    ...
    REAL(wrp), DIMENSION(N_org), INTENT(IN)      :: M_org_j, O2C_org_j, H2C_org_j, N2C_org_j, &	! Molar mass (g/mol) and elemental ratios (O/C, H/C) of each organic species j in the system
    ...
    REAL(wrp), DIMENSION(N_org)                 :: O2C_org_j_wrp, H2C_org_j_wrp, N2C_org_j_wrp, &
													...
													& C_sat_org_j_wrp, C_PM_org_j_alpha_wrp, &
													& C_PM_org_j_beta_wrp
  ...
  !  CALL BAT_INVERSION_VBS_SIMULATION(N_org, M_org_j_wrp, O2C_org_j_wrp, H2C_org_j_wrp, N2C_org_j_wrp, &
    ...
    CALL BAT_INVERSION_VBS_SIMULATION(N_a_water, N_org, M_org_j, O2C_org_j, H2C_org_j, N2C_org_j, &
