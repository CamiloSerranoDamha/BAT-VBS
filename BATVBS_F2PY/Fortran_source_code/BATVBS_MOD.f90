...
CONTAINS
    ...
    SUBROUTINE BAT_INVERSION_SIMULATION(n_species, M_j, O2C_j, H2C_j, N2C_j, Group_j, C_PM_j, a_water, &
        ...
        DO i = 1, n_species ! Start loop through organic species.
            ...
            mass_fraction_water_alpha(i) = mass_fraction_water_a(1) ! 1.0_wrp - mole_frac_fit_a(1)
            mass_fraction_water_beta(i) = mass_fraction_water_b(1) ! 1.0_wrp - mole_frac_fit_b(1)!mass_fraction_water_b(1)
            mass_fraction_org_alpha(i) = mass_fraction_org_a(1)
            mass_fraction_org_beta(i) = mass_fraction_org_b(1)
    ...
    SUBROUTINE BAT_INVERSION_VBS_SIMULATION(n_species, M_j, O2C_j, H2C_j, N2C_j, Csat_j, Ctotal_j, Group_j, aw_bat, Coa_org_alpha, Coa_org_beta, Coa_total_water_alpha, Coa_total_water_beta)
        ...
        ! Output
		REAL(wrp), INTENT(OUT)		                        :: Coa_total_water_alpha, Coa_total_water_beta
		...
		REAL(wrp), DIMENSION(n_species), INTENT(OUT)         :: Coa_org_alpha, Coa_org_beta
		...
		! Outputs
		Coa_org_alpha = Coa_j_alpha(1,:)
		Coa_org_beta =  Coa_j_beta(1,:)
		...
		Coa_total_water_alpha = SUM(Caq_j_alpha)
		Coa_total_water_beta = SUM(Caq_j_beta)
